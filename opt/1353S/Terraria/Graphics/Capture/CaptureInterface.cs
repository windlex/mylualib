...
namespace Terraria.Graphics.Capture
{
	...
	{
		// Token: 0x06000D5A RID: 3418 RVA: 0x003E35D8 File Offset: 0x003E17D8
		...
		// Token: 0x06000D5B RID: 3419 RVA: 0x003E3604 File Offset: 0x003E1804
		public static Rectangle GetArea()
		{
			int arg_70_0 = Math.Min(CaptureInterface.EdgeA.X, CaptureInterface.EdgeB.X);
			...
			return new Rectangle(arg_70_0, y, num + 1, num2 + 1);
		}

		// Token: 0x06000D5C RID: 3420 RVA: 0x003E3688 File Offset: 0x003E1888
		public void Update()
		{
		...
		// Token: 0x06000D5D RID: 3421 RVA: 0x003E37AC File Offset: 0x003E19AC
		public void Draw(SpriteBatch sb)
		{
			...
			PlayerInput.SetZoom_UI();
			using (Dictionary<int, CaptureInterface.CaptureInterfaceMode>.ValueCollection.Enumerator enumerator = CaptureInterface.Modes.Values.GetEnumerator())
			{
		...
		// Token: 0x06000D5E RID: 3422 RVA: 0x003E38F8 File Offset: 0x003E1AF8
		...
		// Token: 0x06000D5F RID: 3423 RVA: 0x003E39BC File Offset: 0x003E1BBC
		...
		// Token: 0x06000D60 RID: 3424 RVA: 0x003E3BA4 File Offset: 0x003E1DA4
		...
		// Token: 0x06000D61 RID: 3425 RVA: 0x003E3C50 File Offset: 0x003E1E50
		...
		// Token: 0x06000D62 RID: 3426 RVA: 0x003E403C File Offset: 0x003E223C
		private static bool GetMapCoords(int PinX, int PinY, int Goal, out Point result)
		{
			...
			float arg_133_0 = Main.mapFullscreenPos.X;
			float num6 = Main.mapFullscreenPos.Y;
			float arg_13A_0 = arg_133_0 * mapFullscreenScale;
			num6 *= mapFullscreenScale;
			float num7 = -arg_13A_0 + (float)(Main.screenWidth / 2);
			float num8 = -num6 + (float)(Main.screenHeight / 2);
			num7 += num * mapFullscreenScale;
			num8 += num2 * mapFullscreenScale;
			float num9 = (float)(Main.maxTilesX / 840);
			num9 *= Main.mapFullscreenScale;
			float num10 = num7;
			float num11 = num8;
			float num12 = (float)Main.mapTexture.Width;
			float num13 = (float)Main.mapTexture.Height;
			...
			if (Goal == 0)
			{
				int num14 = (int)((-num7 + (float)PinX) / mapFullscreenScale + num);
				int num15 = (int)((-num8 + (float)PinY) / mapFullscreenScale + num2);
				bool flag = false;
				if ((float)num14 < num)
				{
					flag = true;
			...
			else
			{
				if (Goal == 1)
				{
					Vector2 value = new Vector2(num7, num8);
		...
		// Token: 0x06000D63 RID: 3427 RVA: 0x003E443C File Offset: 0x003E263C
		...
		// Token: 0x06000D64 RID: 3428 RVA: 0x003E4474 File Offset: 0x003E2674
		...
		// Token: 0x06000D65 RID: 3429 RVA: 0x003E44E4 File Offset: 0x003E26E4
		public bool UsingMap()
		{
			return CaptureInterface.CameraLock || CaptureInterface.Modes[this.SelectedMode].UsingMap();
		}

		// Token: 0x06000D66 RID: 3430 RVA: 0x003E4504 File Offset: 0x003E2704
		...
		// Token: 0x06000D67 RID: 3431 RVA: 0x003E452C File Offset: 0x003E272C
		...
		// Token: 0x06000D68 RID: 3432 RVA: 0x003E45B8 File Offset: 0x003E27B8
		...
		// Token: 0x06000D69 RID: 3433 RVA: 0x003E465C File Offset: 0x003E285C
		...
		// Token: 0x06000D6A RID: 3434 RVA: 0x003E4818 File Offset: 0x003E2A18
		...
		// Token: 0x06000D6B RID: 3435 RVA: 0x003E4848 File Offset: 0x003E2A48
		...
		{
			// Token: 0x06001684 RID: 5764 RVA: 0x00437170 File Offset: 0x00435370
			...
			// Token: 0x06001685 RID: 5765 RVA: 0x004371A8 File Offset: 0x004353A8
			...
			// Token: 0x06001686 RID: 5766 RVA: 0x00437224 File Offset: 0x00435424
			public override void ToggleActive(bool tickedOn)
			{
			}

			// Token: 0x06001687 RID: 5767 RVA: 0x00437228 File Offset: 0x00435428
			public override bool UsingMap()
			{
				return true;
			}

			// Token: 0x06001688 RID: 5768 RVA: 0x0043722C File Offset: 0x0043542C
			...
			// Token: 0x06001689 RID: 5769 RVA: 0x004372C8 File Offset: 0x004354C8
			private void DrawMarkedArea(SpriteBatch sb)
			{
				...
				if (!Main.mapFullscreen)
				{
					...
					for (int i = 0; i < 2; i++)
					{
						sb.Draw(Main.magicPixel, new Rectangle(rectangle3.X, rectangle3.Y + ((i == 1) ? rectangle3.Height : -2), rectangle3.Width, 2), Color.White);
						sb.Draw(Main.magicPixel, new Rectangle(rectangle3.X + ((i == 1) ? rectangle3.Width : -2), rectangle3.Y, 2, rectangle3.Height), Color.White);
					}
					return;
				}
				else
				{
					...
					sb.Draw(Main.magicPixel, rectangle6, CaptureInterface.Settings.MarkedAreaColor);
					for (int j = 0; j < 2; j++)
					{
						sb.Draw(Main.magicPixel, new Rectangle(rectangle6.X, rectangle6.Y + ((j == 1) ? rectangle6.Height : -2), rectangle6.Width, 2), Color.White);
						sb.Draw(Main.magicPixel, new Rectangle(rectangle6.X + ((j == 1) ? rectangle6.Width : -2), rectangle6.Y, 2, rectangle6.Height), Color.White);
					}
					return;
				}
			}

			// Token: 0x0600168A RID: 5770 RVA: 0x004375B8 File Offset: 0x004357B8
		...
		{
			// Token: 0x0600168C RID: 5772 RVA: 0x00437D08 File Offset: 0x00435F08
			public override void Update()
			{
				if (!this.Selected)
				{
			...
			// Token: 0x0600168D RID: 5773 RVA: 0x00437D48 File Offset: 0x00435F48
			public override void Draw(SpriteBatch sb)
			{
				if (!this.Selected)
				{
			...
			// Token: 0x0600168E RID: 5774 RVA: 0x00437DC0 File Offset: 0x00435FC0
			public override void ToggleActive(bool tickedOn)
			{
				if (!tickedOn)
				{
			...
			// Token: 0x0600168F RID: 5775 RVA: 0x00437DCC File Offset: 0x00435FCC
			public override bool UsingMap()
			{
				return this.caughtEdge != -1;
			}

			// Token: 0x06001690 RID: 5776 RVA: 0x00437DDC File Offset: 0x00435FDC
			...
			// Token: 0x06001691 RID: 5777 RVA: 0x00438274 File Offset: 0x00436474
			...
			// Token: 0x06001692 RID: 5778 RVA: 0x0043830C File Offset: 0x0043650C
			...
			// Token: 0x06001693 RID: 5779 RVA: 0x004385F4 File Offset: 0x004367F4
		...
		{
			// Token: 0x06001695 RID: 5781 RVA: 0x0043872C File Offset: 0x0043692C
			...
			// Token: 0x06001696 RID: 5782 RVA: 0x004387C4 File Offset: 0x004369C4
			...
			// Token: 0x06001697 RID: 5783 RVA: 0x00438898 File Offset: 0x00436A98
			...
			// Token: 0x06001698 RID: 5784 RVA: 0x0043890C File Offset: 0x00436B0C
			...
			// Token: 0x06001699 RID: 5785 RVA: 0x00438AD8 File Offset: 0x00436CD8
			...
			// Token: 0x0600169A RID: 5786 RVA: 0x00438B2C File Offset: 0x00436D2C
			public override void Update()
			{
				if (!this.Selected)
				{
			...
			// Token: 0x0600169B RID: 5787 RVA: 0x00438BE8 File Offset: 0x00436DE8
			public override void Draw(SpriteBatch sb)
			{
				if (!this.Selected)
				{
			...
			// Token: 0x0600169C RID: 5788 RVA: 0x00438DC0 File Offset: 0x00436FC0
			public override void ToggleActive(bool tickedOn)
			{
				if (tickedOn)
				{
			...
			// Token: 0x0600169D RID: 5789 RVA: 0x00438DCC File Offset: 0x00436FCC
			public override bool UsingMap()
			{
				return this.inUI;
			}
