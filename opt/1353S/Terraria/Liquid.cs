...
namespace Terraria
{
	...
	public class Liquid
	{
		// Token: 0x060000B5 RID: 181 RVA: 0x00012870 File Offset: 0x00010A70
		...
		// Token: 0x060000B6 RID: 182 RVA: 0x000128D0 File Offset: 0x00010AD0
		...
		// Token: 0x060000B7 RID: 183 RVA: 0x0001293C File Offset: 0x00010B3C
						...
						if (tile.liquid > 0)
						{
							...
							while (flag4 && num9 > 3 && num9 < Main.maxTilesX - 3 && num10 < Main.maxTilesY - 3)
							{
								...
								if (Main.tile[num9, num10 + 1].liquid > 0 && Main.tile[num9, num10 + 1].liquid < 255 && Main.tile[num9, num10 + 1].liquidType() == b)
								{
									...
									Tile expr_2A4 = Main.tile[num9, num10 + 1];
									expr_2A4.liquid += (byte)num12;
									b2 -= (byte)num12;
									if (b2 == 0)
									{
										num++;
		...
		// Token: 0x060000B8 RID: 184 RVA: 0x000130A8 File Offset: 0x000112A8
		public void Update()
		{
			Main.tileSolid[379] = true;
		...
		// Token: 0x060000B9 RID: 185 RVA: 0x0001451C File Offset: 0x0001271C
		...
		// Token: 0x060000BA RID: 186 RVA: 0x00014574 File Offset: 0x00012774
		public static void UpdateLiquid()
		{
			...
			Liquid.wetCounter++;
			int expr_15A = Liquid.maxLiquid / Liquid.cycles;
			int num2 = expr_15A * (Liquid.wetCounter - 1);
			int num3 = expr_15A * Liquid.wetCounter;
		...
		// Token: 0x060000BB RID: 187 RVA: 0x0001497C File Offset: 0x00012B7C
		...
		// Token: 0x060000BC RID: 188 RVA: 0x00014AB4 File Offset: 0x00012CB4
		...
		// Token: 0x060000BD RID: 189 RVA: 0x00014E48 File Offset: 0x00013048
		...
		// Token: 0x060000BE RID: 190 RVA: 0x000151A4 File Offset: 0x000133A4
