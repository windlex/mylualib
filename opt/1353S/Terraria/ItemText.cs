...
namespace Terraria
{
	...
	public class ItemText
	{
		...
		// (get) Token: 0x0600016F RID: 367 RVA: 0x0002BA64 File Offset: 0x00029C64
		...
		// Token: 0x06000171 RID: 369 RVA: 0x0002C5B8 File Offset: 0x0002A7B8
		...
		// Token: 0x06000172 RID: 370 RVA: 0x0002C6F4 File Offset: 0x0002A8F4
		...
		// Token: 0x06000173 RID: 371 RVA: 0x0002C860 File Offset: 0x0002AA60
			...
			if (this.active)
			{
				...
				for (int i = 0; i < 20; i++)
				{
					if (Main.itemText[i].active && i != whoAmI)
					{
						...
						if (rectangle.Intersects(value) && (this.position.Y < Main.itemText[i].position.Y || (this.position.Y == Main.itemText[i].position.Y && whoAmI < i)))
						{
							flag = true;
		...
		// Token: 0x06000174 RID: 372 RVA: 0x0002CC74 File Offset: 0x0002AE74
