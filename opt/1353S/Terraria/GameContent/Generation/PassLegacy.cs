...
namespace Terraria.GameContent.Generation
{
	...
	{
		// Token: 0x06000F50 RID: 3920 RVA: 0x003F3EE8 File Offset: 0x003F20E8
		...
		// Token: 0x06000F51 RID: 3921 RVA: 0x003F3F4C File Offset: 0x003F214C
		public PassLegacy(string name, WorldGenLegacyMethod method) : base(name, PassLegacy.GetWeight(name))
		{
			this._method = method;
		}

		// Token: 0x06000F52 RID: 3922 RVA: 0x003F3F64 File Offset: 0x003F2164
		public PassLegacy(string name, WorldGenLegacyMethod method, float weight) : base(name, weight)
		{
			this._method = method;
		}

		// Token: 0x06000F53 RID: 3923 RVA: 0x003F3F78 File Offset: 0x003F2178
		private static float GetWeight(string name)
		{
			float result;
			if (!PassLegacy._weightMap.TryGetValue(name, out result))
			{
				result = 1f;
			}
			return result;
		...
		// Token: 0x06000F54 RID: 3924 RVA: 0x003F3F9C File Offset: 0x003F219C
