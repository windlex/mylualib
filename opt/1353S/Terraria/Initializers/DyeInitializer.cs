...
namespace Terraria.Initializers
{
	...
	{
		// Token: 0x06000ADA RID: 2778 RVA: 0x003CC03C File Offset: 0x003CA23C
		...
		// Token: 0x06000AD9 RID: 2777 RVA: 0x003CC02B File Offset: 0x003CA22B
		...
		// Token: 0x06000AD5 RID: 2773 RVA: 0x003CAE20 File Offset: 0x003C9020
		...
		// Token: 0x06000AD3 RID: 2771 RVA: 0x003CAC44 File Offset: 0x003C8E44
		...
		// Token: 0x06000AD2 RID: 2770 RVA: 0x003CAB68 File Offset: 0x003C8D68
		...
		// Token: 0x06000AD4 RID: 2772 RVA: 0x003CAC6C File Offset: 0x003C8E6C
		...
		// Token: 0x06000AD6 RID: 2774 RVA: 0x003CBCD0 File Offset: 0x003C9ED0
		...
		// Token: 0x06000AD7 RID: 2775 RVA: 0x003CBD24 File Offset: 0x003C9F24
		private static void LoadLegacyHairdyes()
		{
			...
			GameShaders.Hair.BindShader<LegacyHairShaderData>(1981, new LegacyHairShaderData().UseLegacyMethod((LegacyHairShaderData.ColorProcessingMethod)((Player player, Color newColor, ref bool lighting) =>
			{
				...
				if (Main.dayTime)
				{
					...
					{
						float num1 = (float)((Main.time - 27000.0) / 27000.0);
						float num2 = 1f - num1;
						newColor.R = (byte)((double)color2.R * (double)num2 + (double)color3.R * (double)num1);
						newColor.G = (byte)((double)color2.G * (double)num2 + (double)color3.G * (double)num1);
						newColor.B = (byte)((double)color2.B * (double)num2 + (double)color3.B * (double)num1);
					}
				}
				...
				{
					float num1 = (float)((Main.time - 16200.0) / 16200.0);
					float num2 = 1f - num1;
					newColor.R = (byte)((double)color4.R * (double)num2 + (double)color1.R * (double)num1);
					newColor.G = (byte)((double)color4.G * (double)num2 + (double)color1.G * (double)num1);
					newColor.B = (byte)((double)color4.B * (double)num2 + (double)color1.B * (double)num1);
				}
				return newColor;
			})));
		...
		// Token: 0x06000AD8 RID: 2776 RVA: 0x003CBFAC File Offset: 0x003CA1AC
