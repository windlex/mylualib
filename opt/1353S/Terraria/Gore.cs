...
namespace Terraria
{
	...
	public class Gore
	{
		// Token: 0x06000086 RID: 134 RVA: 0x0000B5C4 File Offset: 0x000097C4
		...
		// Token: 0x06000084 RID: 132 RVA: 0x0000AF4C File Offset: 0x0000914C
		...
		// Token: 0x06000083 RID: 131 RVA: 0x0000AF33 File Offset: 0x00009133
		public static Gore NewGorePerfect(Vector2 Position, Vector2 Velocity, int Type, float Scale = 1f)
		{
			Gore expr_09 = Gore.NewGoreDirect(Position, Velocity, Type, Scale);
			expr_09.position = Position;
			expr_09.velocity = Velocity;
			return expr_09;
		}

		// Token: 0x06000082 RID: 130 RVA: 0x00008F74 File Offset: 0x00007174
		public void Update()
		{
			if (Main.netMode == 2)
			{
			...
			if (this.active)
			{
					...
					if (this.frame <= 4)
					{
						...
						if ((int)this.frameCounter >= num)
						{
							...
							if (this.type == 943 && this.frame > 4)
							{
								...
								{
									Gore expr_3B0 = Main.gore[Gore.NewGore(this.position, this.velocity, this.type, this.scale)];
									expr_3B0.frameCounter = 0;
									expr_3B0.frame = 7;
									expr_3B0.velocity = Vector2.UnitY * 1f;
								}
								if (Main.rand.Next(2) == 0)
								{
									Gore expr_405 = Main.gore[Gore.NewGore(this.position, this.velocity, this.type, this.scale)];
									expr_405.frameCounter = 0;
									expr_405.frame = 7;
									expr_405.velocity = Vector2.UnitY * 2f;
								}
							}
						}
					}
				...
				{
					byte b = (byte)(this.frameCounter + 1);
					this.frameCounter = b;
				...
				else if (GoreID.Sets.SpecialAI[this.type] != 3 && GoreID.Sets.SpecialAI[this.type] != 1)
				{
					...
					else if (this.sticky)
					{
						...
						Vector2 arg_16E5_0 = this.velocity;
