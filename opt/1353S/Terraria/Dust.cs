...
namespace Terraria
{
	...
	public class Dust
	{
		// Token: 0x06000424 RID: 1060 RVA: 0x002867B4 File Offset: 0x002849B4
		public static Dust CloneDust(int dustIndex)
		{
			return Dust.CloneDust(Main.dust[dustIndex]);
		}

		// Token: 0x06000425 RID: 1061 RVA: 0x002867C4 File Offset: 0x002849C4
		public static Dust CloneDust(Dust rf)
		{
			...
			Dust expr_43 = Main.dust[num];
			expr_43.position = rf.position;
			expr_43.velocity = rf.velocity;
			expr_43.fadeIn = rf.fadeIn;
			expr_43.noGravity = rf.noGravity;
			expr_43.scale = rf.scale;
			expr_43.rotation = rf.rotation;
			expr_43.noLight = rf.noLight;
			expr_43.active = rf.active;
			expr_43.type = rf.type;
			expr_43.color = rf.color;
			expr_43.alpha = rf.alpha;
			expr_43.frame = rf.frame;
			expr_43.shader = rf.shader;
			expr_43.customData = rf.customData;
			return expr_43;
		}

		// Token: 0x0600042A RID: 1066 RVA: 0x00286A9C File Offset: 0x00284C9C
		...
		// Token: 0x0600042C RID: 1068 RVA: 0x0028BA1C File Offset: 0x00289C1C
		public Color GetAlpha(Color newColor)
		{
			...
			{
				int expr_19E = (int)(this.scale / 2.5f * 255f);
				return new Color(expr_19E, expr_19E, expr_19E, expr_19E);
			}
			...
			{
				int expr_3E1 = (int)(250f * this.scale);
				return new Color(expr_3E1, expr_3E1, expr_3E1, 0);
			}
			...
			if (this.type == 157)
			{
				...
				return new Color(num3, num2, num4, a);
			}
		...
		// Token: 0x0600042D RID: 1069 RVA: 0x0028C3DC File Offset: 0x0028A5DC
		...
		// Token: 0x06000423 RID: 1059 RVA: 0x00286184 File Offset: 0x00284384
		public static int NewDust(Vector2 Position, int Width, int Height, int Type, float SpeedX = 0f, float SpeedY = 0f, int Alpha = 0, Color newColor = default(Color), float Scale = 1f)
		{
			...
			while (i < 6000)
			{
				...
				if (!dust.active)
				{
					...
					{
						j -= 100;
						Dust expr_2FB_cp_0_cp_0 = dust;
						expr_2FB_cp_0_cp_0.frame.X = expr_2FB_cp_0_cp_0.frame.X - 1000;
						Dust expr_310_cp_0_cp_0 = dust;
						expr_310_cp_0_cp_0.frame.Y = expr_310_cp_0_cp_0.frame.Y + 30;
					}
					dust.frame.Width = 8;
					dust.frame.Height = 8;
					dust.rotation = 0f;
					...
					if (dust.type == 228 || dust.type == 269 || dust.type == 135 || dust.type == 6 || dust.type == 242 || dust.type == 75 || dust.type == 169 || dust.type == 29 || (dust.type >= 59 && dust.type <= 65) || dust.type == 158)
					{
						...
						Dust expr_43A_cp_0_cp_0 = dust;
						expr_43A_cp_0_cp_0.velocity.X = expr_43A_cp_0_cp_0.velocity.X * 0.3f;
						dust.scale *= 0.7f;
					}
					...
					if (dust.type == 33 || dust.type == 52 || dust.type == 266 || dust.type == 98 || dust.type == 99 || dust.type == 100 || dust.type == 101 || dust.type == 102 || dust.type == 103 || dust.type == 104 || dust.type == 105)
					{
						dust.alpha = 170;
						dust.velocity *= 0.5f;
						Dust expr_544_cp_0_cp_0 = dust;
						expr_544_cp_0_cp_0.velocity.Y = expr_544_cp_0_cp_0.velocity.Y + 1f;
					}
					if (dust.type == 41)
					{
						dust.velocity *= 0f;
		...
		// Token: 0x06000422 RID: 1058 RVA: 0x00286144 File Offset: 0x00284344
		...
		// Token: 0x06000421 RID: 1057 RVA: 0x002860F8 File Offset: 0x002842F8
		...
		// Token: 0x06000427 RID: 1063 RVA: 0x002868D4 File Offset: 0x00284AD4
		...
		// Token: 0x06000426 RID: 1062 RVA: 0x002868BC File Offset: 0x00284ABC
		public static Dust QuickDust(Point tileCoords, Color color)
		{
			return Dust.QuickDust(tileCoords.ToWorldCoordinates(8f, 8f), color);
		}

		// Token: 0x06000428 RID: 1064 RVA: 0x002869CC File Offset: 0x00284BCC
		public static Dust QuickDust(Vector2 pos, Color color)
		{
			Dust expr_2C = Main.dust[Dust.NewDust(pos, 0, 0, 267, 0f, 0f, 0, default(Color), 1f)];
			expr_2C.position = pos;
			expr_2C.velocity = Vector2.Zero;
			expr_2C.fadeIn = 1f;
			expr_2C.noLight = true;
			expr_2C.noGravity = true;
			expr_2C.color = color;
			return expr_2C;
		}

		// Token: 0x06000429 RID: 1065 RVA: 0x00286A38 File Offset: 0x00284C38
		...
		// Token: 0x0600042B RID: 1067 RVA: 0x00286AFC File Offset: 0x00284CFC
					...
					if (dust.active)
					{
						...
						if (dust.firstFrame && !ChildSafety.Disabled && ChildSafety.DangerousDust(dust.type))
						{
							if (Main.rand.Next(2) == 0)
							{
								...
								Dust expr_152_cp_0_cp_0 = dust;
								expr_152_cp_0_cp_0.frame.X = expr_152_cp_0_cp_0.frame.X - 1000 * num2;
								Dust expr_169_cp_0_cp_0 = dust;
								expr_169_cp_0_cp_0.frame.Y = expr_169_cp_0_cp_0.frame.Y + 30 * num2;
								dust.noGravity = true;
							}
							else
							{
						...
						if ((dust.type == 259 || dust.type == 6 || dust.type == 158) && dust.customData != null && dust.customData is int)
						{
							...
							{
								dust.scale *= 0.98f;
								Dust expr_584_cp_0_cp_0 = dust;
								expr_584_cp_0_cp_0.velocity.Y = expr_584_cp_0_cp_0.velocity.Y * 0.98f;
								if (Collision.SolidCollision(dust.position - Vector2.One * 5f, 10, 10) && dust.fadeIn == 0f)
								{
									dust.scale *= 0.9f;
									dust.velocity *= 0.25f;
						...
						else if (dust.type == 228 || dust.type == 229 || dust.type == 6 || dust.type == 242 || dust.type == 135 || dust.type == 127 || dust.type == 187 || dust.type == 75 || dust.type == 169 || dust.type == 29 || (dust.type >= 59 && dust.type <= 65) || dust.type == 158)
						{
							if (!dust.noGravity)
							{
								Dust expr_124B_cp_0_cp_0 = dust;
								expr_124B_cp_0_cp_0.velocity.Y = expr_124B_cp_0_cp_0.velocity.Y + 0.05f;
							}
						...
						else if (dust.type == 269)
						{
							if (!dust.noLight)
							{
								...
								Lighting.AddLight(dust.position, value2 * num66);
							}
							if (dust.customData != null && dust.customData is Vector2)
							{
								Vector2 vector4 = (Vector2)dust.customData - dust.position;
								Dust expr_19C8_cp_0_cp_0 = dust;
								expr_19C8_cp_0_cp_0.velocity.X = expr_19C8_cp_0_cp_0.velocity.X + 1f * (float)Math.Sign(vector4.X) * dust.scale;
							}
						}
						else if (dust.type == 159)
						{
							...
							else
							{
								dust.scale += 0.005f;
								dust.velocity *= 0.9f;
								Dust expr_1B00_cp_0_cp_0 = dust;
								expr_1B00_cp_0_cp_0.velocity.X = expr_1B00_cp_0_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.02f;
								Dust expr_1B24_cp_0_cp_0 = dust;
								expr_1B24_cp_0_cp_0.velocity.Y = expr_1B24_cp_0_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.02f;
								if (Main.rand.Next(5) == 0)
								{
						...
						else if (dust.type == 164)
						{
							...
							else
							{
								dust.scale -= 0.005f;
								dust.velocity *= 0.9f;
								Dust expr_1CBD_cp_0_cp_0 = dust;
								expr_1CBD_cp_0_cp_0.velocity.X = expr_1CBD_cp_0_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.02f;
								Dust expr_1CE1_cp_0_cp_0 = dust;
								expr_1CE1_cp_0_cp_0.velocity.Y = expr_1CE1_cp_0_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.02f;
								if (Main.rand.Next(5) == 0)
								{
						...
						else if (dust.type == 173)
						{
							...
							{
								dust.velocity *= 0.8f;
								Dust expr_1DF1_cp_0_cp_0 = dust;
								expr_1DF1_cp_0_cp_0.velocity.X = expr_1DF1_cp_0_cp_0.velocity.X + (float)Main.rand.Next(-20, 21) * 0.01f;
								Dust expr_1E15_cp_0_cp_0 = dust;
								expr_1E15_cp_0_cp_0.velocity.Y = expr_1E15_cp_0_cp_0.velocity.Y + (float)Main.rand.Next(-20, 21) * 0.01f;
								dust.scale -= 0.01f;
							}
							else
							{
								dust.scale -= 0.015f;
								dust.velocity *= 0.8f;
								Dust expr_1E78_cp_0_cp_0 = dust;
								expr_1E78_cp_0_cp_0.velocity.X = expr_1E78_cp_0_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.005f;
								Dust expr_1E9C_cp_0_cp_0 = dust;
								expr_1E9C_cp_0_cp_0.velocity.Y = expr_1E9C_cp_0_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.005f;
						...
						else if (dust.type == 160 || dust.type == 162)
						{
							...
							{
								dust.velocity *= 0.8f;
								Dust expr_2045_cp_0_cp_0 = dust;
								expr_2045_cp_0_cp_0.velocity.X = expr_2045_cp_0_cp_0.velocity.X + (float)Main.rand.Next(-20, 21) * 0.04f;
								Dust expr_2069_cp_0_cp_0 = dust;
								expr_2069_cp_0_cp_0.velocity.Y = expr_2069_cp_0_cp_0.velocity.Y + (float)Main.rand.Next(-20, 21) * 0.04f;
								dust.scale -= 0.1f;
							}
							else
							{
								dust.scale -= 0.1f;
								Dust expr_20B6_cp_0_cp_0 = dust;
								expr_20B6_cp_0_cp_0.velocity.X = expr_20B6_cp_0_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.02f;
								Dust expr_20DA_cp_0_cp_0 = dust;
								expr_20DA_cp_0_cp_0.velocity.Y = expr_20DA_cp_0_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.02f;
						...
						else if (dust.type == 168)
						{
							...
							dust.scale += 0.03f;
							Dust expr_221D_cp_0_cp_0 = dust;
							expr_221D_cp_0_cp_0.velocity.X = expr_221D_cp_0_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.02f;
							Dust expr_2241_cp_0_cp_0 = dust;
							expr_2241_cp_0_cp_0.velocity.Y = expr_2241_cp_0_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.02f;
							dust.velocity *= 0.99f;
						}
						else if (dust.type >= 139 && dust.type < 143)
						{
							Dust expr_22A0_cp_0_cp_0 = dust;
							expr_22A0_cp_0_cp_0.velocity.X = expr_22A0_cp_0_cp_0.velocity.X * 0.98f;
							Dust expr_22B4_cp_0_cp_0 = dust;
							expr_22B4_cp_0_cp_0.velocity.Y = expr_22B4_cp_0_cp_0.velocity.Y * 0.98f;
							if (dust.velocity.Y < 1f)
							{
								Dust expr_22DA_cp_0_cp_0 = dust;
								expr_22DA_cp_0_cp_0.velocity.Y = expr_22DA_cp_0_cp_0.velocity.Y + 0.05f;
							}
							dust.scale += 0.009f;
						...
						{
							Dust expr_23AD_cp_0_cp_0 = dust;
							expr_23AD_cp_0_cp_0.velocity.Y = expr_23AD_cp_0_cp_0.velocity.Y * 0.98f;
							Dust expr_23C1_cp_0_cp_0 = dust;
							expr_23C1_cp_0_cp_0.velocity.X = expr_23C1_cp_0_cp_0.velocity.X * 0.98f;
						...
						{
							dust.scale -= 0.01f;
							Dust expr_246A_cp_0_cp_0 = dust;
							expr_246A_cp_0_cp_0.velocity.X = expr_246A_cp_0_cp_0.velocity.X * 0.96f;
							if (!dust.noGravity)
							{
								Dust expr_2489_cp_0_cp_0 = dust;
								expr_2489_cp_0_cp_0.velocity.Y = expr_2489_cp_0_cp_0.velocity.Y + 0.1f;
							}
						}
						else if (dust.type >= 244 && dust.type <= 247)
						{
							...
							byte expr_2515 = (byte)((color.R + color.G + color.B) / 3);
							float num76 = ((float)expr_2515 / 270f + 1f) / 2f;
							float num77 = ((float)expr_2515 / 270f + 1f) / 2f;
							float num78 = ((float)expr_2515 / 270f + 1f) / 2f;
						...
						{
							Dust expr_295E_cp_0_cp_0 = dust;
							expr_295E_cp_0_cp_0.velocity.Y = expr_295E_cp_0_cp_0.velocity.Y * 0.98f;
							Dust expr_2972_cp_0_cp_0 = dust;
							expr_2972_cp_0_cp_0.velocity.X = expr_2972_cp_0_cp_0.velocity.X * 0.98f;
						...
						else if (dust.type == 66)
						{
							...
							Dust expr_2D76_cp_0_cp_0 = dust;
							expr_2D76_cp_0_cp_0.velocity.Y = expr_2D76_cp_0_cp_0.velocity.Y * 0.98f;
							Dust expr_2D8A_cp_0_cp_0 = dust;
							expr_2D8A_cp_0_cp_0.velocity.X = expr_2D8A_cp_0_cp_0.velocity.X * 0.98f;
							dust.scale += 0.02f;
						...
						else if (dust.type == 267)
						{
							...
							Dust expr_2E95_cp_0_cp_0 = dust;
							expr_2E95_cp_0_cp_0.velocity.Y = expr_2E95_cp_0_cp_0.velocity.Y * 0.98f;
							Dust expr_2EA9_cp_0_cp_0 = dust;
							expr_2EA9_cp_0_cp_0.velocity.X = expr_2EA9_cp_0_cp_0.velocity.X * 0.98f;
							dust.scale += 0.02f;
						...
						{
							dust.scale += 0.005f;
							Dust expr_2FAA_cp_0_cp_0 = dust;
							expr_2FAA_cp_0_cp_0.velocity.Y = expr_2FAA_cp_0_cp_0.velocity.Y * 0.94f;
							Dust expr_2FBE_cp_0_cp_0 = dust;
							expr_2FBE_cp_0_cp_0.velocity.X = expr_2FBE_cp_0_cp_0.velocity.X * 0.94f;
						...
						else if (dust.type == 76)
						{
							...
							{
								Dust expr_3591_cp_0_cp_0 = dust;
								expr_3591_cp_0_cp_0.position.Y = expr_3591_cp_0_cp_0.position.Y + Main.player[Main.myPlayer].velocity.Y * 0.2f;
							}
							if (Collision.SolidCollision(dust.position - Vector2.One * 5f, 10, 10) && dust.fadeIn == 0f)
							{
								dust.scale *= 0.9f;
						...
						else if (dust.type == 270)
						{
							...
							else
							{
								...
								Dust expr_36EB_cp_0_cp_0 = dust;
								expr_36EB_cp_0_cp_0.velocity.Y = expr_36EB_cp_0_cp_0.velocity.Y - 3f;
								Dust expr_36FF_cp_0_cp_0 = dust;
								expr_36FF_cp_0_cp_0.velocity.Y = expr_36FF_cp_0_cp_0.velocity.Y / 20f;
							}
						}
						else if (dust.type == 271)
						{
							...
							dust.scale += 0.003f;
							dust.rotation = 0f;
							Dust expr_3758_cp_0_cp_0 = dust;
							expr_3758_cp_0_cp_0.velocity.Y = expr_3758_cp_0_cp_0.velocity.Y - 4f;
							Dust expr_376C_cp_0_cp_0 = dust;
							expr_376C_cp_0_cp_0.velocity.Y = expr_376C_cp_0_cp_0.velocity.Y / 6f;
						}
						else if (dust.type == 268)
						{
							...
							{
								Dust expr_3858_cp_0_cp_0 = dust;
								expr_3858_cp_0_cp_0.position.Y = expr_3858_cp_0_cp_0.position.Y + y2 * 0.2f;
							}
							if (Collision.SolidCollision(dust.position - Vector2.One * 5f, 10, 10) && dust.fadeIn == 0f)
							{
								dust.scale *= 0.9f;
							...
							{
								dust.velocity.Y = (float)Math.Sin((double)(dust.position.X * 0.00439822953f)) * 2f;
								Dust expr_38F7_cp_0_cp_0 = dust;
								expr_38F7_cp_0_cp_0.velocity.Y = expr_38F7_cp_0_cp_0.velocity.Y + 3f;
							}
						}
						else if (!dust.noGravity && dust.type != 41 && dust.type != 44)
						{
							...
							{
								Dust expr_394B_cp_0_cp_0 = dust;
								expr_394B_cp_0_cp_0.velocity.Y = expr_394B_cp_0_cp_0.velocity.Y + 0.1f;
							}
						}
						...
						if (dust.type == 33 || dust.type == 52 || dust.type == 266 || dust.type == 98 || dust.type == 99 || dust.type == 100 || dust.type == 101 || dust.type == 102 || dust.type == 103 || dust.type == 104 || dust.type == 105 || dust.type == 123)
						{
							...
							if (dust.noGravity)
							{
								...
								dust.scale += 0.03f;
								Dust expr_3B4E_cp_0_cp_0 = dust;
								expr_3B4E_cp_0_cp_0.velocity.X = expr_3B4E_cp_0_cp_0.velocity.X * 1.05f;
								Dust expr_3B62_cp_0_cp_0 = dust;
								expr_3B62_cp_0_cp_0.velocity.Y = expr_3B62_cp_0_cp_0.velocity.Y + 0.15f;
							}
						}
						if (dust.type == 35 && dust.noGravity)
						{
							...
							if (dust.scale < 1f)
							{
								Dust expr_3BAD_cp_0_cp_0 = dust;
								expr_3BAD_cp_0_cp_0.velocity.Y = expr_3BAD_cp_0_cp_0.velocity.Y + 0.075f;
							}
							Dust expr_3BC1_cp_0_cp_0 = dust;
							expr_3BC1_cp_0_cp_0.velocity.X = expr_3BC1_cp_0_cp_0.velocity.X * 1.08f;
							if (dust.velocity.X > 0f)
							{
								dust.rotation += 0.01f;
							}
						...
						else if (dust.type == 152 && dust.noGravity)
						{
							...
							if (dust.scale < 1f)
							{
								Dust expr_3CAB_cp_0_cp_0 = dust;
								expr_3CAB_cp_0_cp_0.velocity.Y = expr_3CAB_cp_0_cp_0.velocity.Y + 0.075f;
							}
							Dust expr_3CBF_cp_0_cp_0 = dust;
							expr_3CBF_cp_0_cp_0.velocity.X = expr_3CBF_cp_0_cp_0.velocity.X * 1.08f;
							if (dust.velocity.X > 0f)
							{
								dust.rotation += 0.01f;
							}
						...
						else if (dust.type == 34 || dust.type == 35 || dust.type == 152)
						{
							...
							else
							{
								...
								Dust expr_3F59_cp_0_cp_0 = dust;
								expr_3F59_cp_0_cp_0.velocity.X = expr_3F59_cp_0_cp_0.velocity.X + (float)Main.rand.Next(-10, 10) * 0.002f;
						...
						if (dust.type == 41)
						{
							Dust expr_4104_cp_0_cp_0 = dust;
							expr_4104_cp_0_cp_0.velocity.X = expr_4104_cp_0_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.01f;
							Dust expr_4128_cp_0_cp_0 = dust;
							expr_4128_cp_0_cp_0.velocity.Y = expr_4128_cp_0_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.01f;
						...
						{
							Dust expr_4265_cp_0_cp_0 = dust;
							expr_4265_cp_0_cp_0.velocity.X = expr_4265_cp_0_cp_0.velocity.X + (float)Main.rand.Next(-10, 11) * 0.003f;
							Dust expr_4289_cp_0_cp_0 = dust;
							expr_4289_cp_0_cp_0.velocity.Y = expr_4289_cp_0_cp_0.velocity.Y + (float)Main.rand.Next(-10, 11) * 0.003f;
						...
						{
							Dust expr_43B6_cp_0_cp_0 = dust;
							expr_43B6_cp_0_cp_0.velocity.X = expr_43B6_cp_0_cp_0.velocity.X * 0.99f;
						}
						...
						if (dust.fadeIn > 0f && dust.fadeIn < 100f)
						{
							if (dust.type == 235)
							{
								...
								{
									Vector2 vector5 = dust.position - Main.player[num107].Center;
									float num108 = vector5.Length();
									num108 = 100f - num108;
									if (num108 > 0f)
									{
						...
						if (dust.type >= 130 && dust.type <= 134)
						{
							...
							{
								dust.velocity *= 0.98f;
								Dust expr_478C_cp_0_cp_0 = dust;
								expr_478C_cp_0_cp_0.velocity.Y = expr_478C_cp_0_cp_0.velocity.Y - 0.1f;
								dust.scale += 0.0025f;
							}
							else
							{
