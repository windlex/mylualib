...
namespace Terraria
{
	...
	public class Recipe
	{
		// Token: 0x060001F9 RID: 505 RVA: 0x000BFB60 File Offset: 0x000BDD60
		public Recipe()
		{
		...
		// Token: 0x060001F8 RID: 504 RVA: 0x000BFADC File Offset: 0x000BDCDC
		...
		// Token: 0x06000205 RID: 517 RVA: 0x000EB520 File Offset: 0x000E9720
		...
		// Token: 0x060001FA RID: 506 RVA: 0x000BFBD0 File Offset: 0x000BDDD0
		public void Create()
		{
			for (int i = 0; i < Recipe.maxRequirements; i++)
			{
		...
		// Token: 0x06000200 RID: 512 RVA: 0x000C01A8 File Offset: 0x000BE3A8
		public static void FindRecipes()
		{
			...
			else
			{
				...
				while (num4 < Recipe.maxRecipes && Main.recipe[num4].createItem.type != 0)
				{
					...
					if (flag)
					{
						bool arg_688_0 = !Main.recipe[num4].needWater || Main.player[Main.myPlayer].adjWater || Main.player[Main.myPlayer].adjTile[172];
						bool flag3 = !Main.recipe[num4].needHoney || Main.recipe[num4].needHoney == Main.player[Main.myPlayer].adjHoney;
						bool flag4 = !Main.recipe[num4].needLava || Main.recipe[num4].needLava == Main.player[Main.myPlayer].adjLava;
						bool flag5 = !Main.recipe[num4].needSnowBiome || Main.player[Main.myPlayer].ZoneSnow;
						if (!(arg_688_0 & flag3 & flag4 & flag5))
						{
							flag = false;
						}
					}
		...
		// Token: 0x06000203 RID: 515 RVA: 0x000EB240 File Offset: 0x000E9440
		...
		// Token: 0x060001F7 RID: 503 RVA: 0x000BFA50 File Offset: 0x000BDC50
		...
		// Token: 0x060001F6 RID: 502 RVA: 0x000BFA28 File Offset: 0x000BDC28
		...
		// Token: 0x06000201 RID: 513 RVA: 0x000C090C File Offset: 0x000BEB0C
		public static void SetupRecipeGroups()
		{
			RecipeGroup rec = new RecipeGroup(() => { return Lang.misc[37].Value + " " + Lang.GetNPCNameValue(74); }, new int[]
			{
				2015,
				2016,
				2017
			...
			rec = new RecipeGroup(() => { return Lang.misc[37].Value + " " + Lang.GetNPCNameValue(367); }, new int[]
			{
				2157,
				2156
			});
			RecipeGroupID.Scorpions = RecipeGroup.RegisterGroup("Scorpions", rec);
			rec = new RecipeGroup(() => { return Lang.misc[37].Value + " " + Lang.GetNPCNameValue(299); }, new int[]
			{
				2018,
				3563
			});
			RecipeGroupID.Squirrels = RecipeGroup.RegisterGroup("Squirrels", rec);
			rec = new RecipeGroup(() => { return Lang.misc[37].Value + " " + Lang.misc[85].Value; }, new int[]
			{
				3194,
				3192,
				3193
			...
			rec = new RecipeGroup(() => { return Lang.misc[37].Value + " " + Lang.misc[86].Value; }, new int[]
			{
				2123,
				2122
			});
			RecipeGroupID.Ducks = RecipeGroup.RegisterGroup("Ducks", rec);
			rec = new RecipeGroup(() => { return Lang.misc[37].Value + " " + Lang.misc[87].Value; }, new int[]
			{
				1998,
				2001,
				1994,
			...
			rec = new RecipeGroup(() => { return Lang.misc[37].Value + " " + Lang.misc[88].Value; }, new int[]
			{
				1992,
				2004
			});
			RecipeGroupID.Fireflies = RecipeGroup.RegisterGroup("Fireflies", rec);
			rec = new RecipeGroup(() => { return Lang.misc[37].Value + " " + Lang.misc[95].Value; }, new int[]
			{
				2006,
				2007
			});
		...
		// Token: 0x06000202 RID: 514 RVA: 0x000C0B64 File Offset: 0x000BED64
		public static void SetupRecipes()
		{
			...
			Recipe.newRecipe.requiredItem[1].SetDefaults(225, false);
			Recipe.newRecipe.requiredItem[1].stack = stack;
			Recipe.newRecipe.requiredTile[0] = 106;
			Recipe.AddRecipe();
			...
			Recipe.newRecipe.requiredItem[0].SetDefaults(22, false);
			Recipe.newRecipe.requiredItem[0].stack = 3;
			Recipe.newRecipe.requiredItem[1].SetDefaults(type4, false);
			...
			Recipe.newRecipe.requiredItem[0].SetDefaults(type4, false);
			Recipe.newRecipe.requiredItem[0].stack = (int)((float)num * 2.5f);
			Recipe.newRecipe.requiredItem[1].SetDefaults(225, false);
			Recipe.newRecipe.requiredItem[1].stack = stack;
			Recipe.newRecipe.requiredTile[0] = 106;
			Recipe.AddRecipe();
			...
			{
				Recipe.newRecipe.createItem.SetDefaults(array[j, 0], false);
				Recipe.newRecipe.requiredItem[0].SetDefaults(array[j, 1], false);
				Recipe.newRecipe.requiredItem[1].SetDefaults(530, false);
				Recipe.newRecipe.requiredItem[1].stack = 10;
				Recipe.newRecipe.requiredTile[0] = 283;
				Recipe.AddRecipe();
			...
			{
				Recipe.newRecipe.createItem.SetDefaults(k, false);
				Recipe.newRecipe.requiredItem[0].SetDefaults(9, false);
				Recipe.newRecipe.requiredItem[0].stack = 12;
				Recipe.newRecipe.requiredItem[1].SetDefaults(22, false);
				Recipe.newRecipe.requiredItem[1].stack = 3;
			...
			for (int l = 3309; l <= 3314; l++)
			{
				...
				Recipe.newRecipe.requiredItem[2].SetDefaults(l, false);
			...
			for (int m = 0; m < 36; m++)
			{
				Recipe.newRecipe.createItem.SetDefaults(2702 + m, false);
				Recipe.newRecipe.requiredItem[0].SetDefaults(3, false);
				Recipe.newRecipe.requiredItem[0].stack = 50;
				Recipe.newRecipe.requiredTile[0] = 283;
				Recipe.AddRecipe();
			}
			int[,] expr_19521 = new int[,]
			{
				{
					444,
					-1,
			...
			expr_19521[2, 1] = RecipeGroupID.Squirrels;
			expr_19521[3, 1] = RecipeGroupID.Butterflies;
			expr_19521[4, 1] = RecipeGroupID.Fireflies;
			expr_19521[5, 1] = RecipeGroupID.Scorpions;
			expr_19521[6, 1] = RecipeGroupID.Snails;
			expr_19521[8, 1] = RecipeGroupID.Ducks;
			expr_19521[11, 1] = RecipeGroupID.Bugs;
			expr_19521[13, 1] = RecipeGroupID.Birds;
			int[,] array2 = expr_19521;
			for (int n = 0; n < array2.GetLength(0); n++)
			{
				Recipe.newRecipe.createItem.SetDefaults(array2[n, 0], false);
				int num2 = 0;
				Recipe.newRecipe.requiredItem[num2].SetDefaults(3, false);
				Recipe.newRecipe.requiredItem[num2].stack = 50;
				int num3 = array2[n, 1];
				if (num3 != -1)
				{
					RecipeGroup recipeGroup = RecipeGroup.recipeGroups[num3];
					Recipe.newRecipe.requiredItem[++num2].SetDefaults(recipeGroup.ValidItems[recipeGroup.IconicItemIndex], false);
					Recipe.newRecipe.requiredItem[num2].stack = 5;
					Recipe.newRecipe.acceptedGroups.Add(num3);
				}
				int num4 = array2[n, 2];
				if (num4 != -1)
				{
					Recipe.newRecipe.requiredItem[++num2].SetDefaults(num4, false);
					Recipe.newRecipe.requiredItem[num2].stack = 5;
				}
				Recipe.newRecipe.requiredTile[0] = 283;
				Recipe.AddRecipe();
			...
			{
				Recipe.newRecipe.createItem.SetDefaults(2178 + num5, false);
				Recipe.newRecipe.requiredItem[0].SetDefaults(1994 + num5, false);
				Recipe.newRecipe.requiredItem[0].stack = 1;
			...
			for (int num6 = 0; num6 < Recipe.numRecipes; num6++)
			{
				...
				{
					Main.recipe[num6].requiredItem[num7].checkMat();
					num7++;
				}
				Main.recipe[num6].createItem.checkMat();
			}
			int arg_2A6CD_0 = Recipe.numRecipes;
		}

		// Token: 0x060001FE RID: 510 RVA: 0x000C00D4 File Offset: 0x000BE2D4
		...
		// Token: 0x060001FC RID: 508 RVA: 0x000C003A File Offset: 0x000BE23A
		public bool useIronBar(int invType, int reqType)
		{
			return this.anyIronBar && (reqType == 22 || reqType == 704) && (invType == 22 || invType == 704);
		}

		// Token: 0x060001FF RID: 511 RVA: 0x000C0130 File Offset: 0x000BE330
		public bool usePressurePlate(int invType, int reqType)
		{
			...
			else if (reqType - 852 <= 1 || reqType == 1151)
			{
				goto IL_3A;
			}
			return false;
			...
			else if (invType - 852 <= 1 || invType == 1151)
			{
				return true;
			}
			return false;
		...
		// Token: 0x060001FD RID: 509 RVA: 0x000C0068 File Offset: 0x000BE268
		...
		// Token: 0x060001FB RID: 507 RVA: 0x000BFFB8 File Offset: 0x000BE1B8
		public bool useWood(int invType, int reqType)
		{
			...
			if (reqType <= 621)
			{
				if (reqType == 9 || reqType - 619 <= 2)
				{
					goto IL_3F;
				}
			}
			else if (reqType == 911 || reqType == 1729 || reqType - 2503 <= 1)
			{
				goto IL_3F;
			}
			return false;
			...
			if (invType <= 621)
			{
				if (invType == 9 || invType - 619 <= 2)
				{
					return true;
				}
			}
			else if (invType == 911 || invType == 1729 || invType - 2503 <= 1)
			{
				return true;
			}
			return false;
		...
		// Token: 0x06000204 RID: 516 RVA: 0x000EB3B0 File Offset: 0x000E95B0
